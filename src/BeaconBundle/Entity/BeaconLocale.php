 ...
 * @ORM\Entity(repositoryClass="BeaconBundle\Repository\BeaconLocaleRepository")
 */
class BeaconLocale
{
    /**
     ...
     * @var Beacon
     *
     * @ORM\ManyToOne(targetEntity="BeaconBundle\Entity\Beacon")
     ...
     * @var Locale
     *
     * @ORM\ManyToOne(targetEntity="BeaconBundle\Entity\Locale")
